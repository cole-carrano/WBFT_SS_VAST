...
#Control file for WBFT.2017
2cc_WBFT1_2021_AK_compress_GOM_LL.dat
2cc_WBFT2021_mat_old_alt4_0831F17asymptotic.ctl
...
2030 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs
0 # N individual STD years 
#vector of year values 

0.0001 # final convergence criteria (e.g. 1.0e-04) 
0 # retrospective year relative to end year (e.g. -4)
9 # min age for calc of summary biomass
...
4 # Annual_F_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Apical_F's); 4=true F for range of ages; 5=unweighted avg. F for range of ages
 10 20 #_min and max age over which average F will be calculated, with F=Z-M
